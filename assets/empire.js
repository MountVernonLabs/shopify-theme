  ...
  createClass(NavMobileSubMenus, [{
    ...
    value: function _bindEvents() {
      ...
      this.$el.on('mousedown.mobile-nav', '.navmenu-link', function (event) {
        event.preventDefault();
        console.log('mousedown.mobile-nav');

      });
//       var test = false;
      
	  this.$el.on('click.mobile-nav', this.navTrigger + ' > .navmenu-link-parent span.navmenu-icon', function (event) {
        console.log('click.mobile-nav    span');
        event.preventDefault();
//         $(this).parent('.navmenu-link-parent').parent('.navmenu-item-parent').toggleClass('navmenu-link-parent-active');

        $(this).parent('.navmenu-link-parent').parent('.navmenu-item-parent').toggleClass('navmenu-link-parent-active');
//         $(this).parent('.navmenu-link-parent').parent('.navmenu-item-parent').children('.navmenu-submenu').slideToggle();
...
//           console.log('click.mobile-nav    aaa');
// //           event.preventDefault();
...
//     this.$el.on('mouseenter.navmenu', this.navTrigger + ' > .navmenu-link-parent', function (event) {
//       event.preventDefault();
...
//     this.$el.on('mouseout.navmenu', this.navTrigger + ' > .navmenu-link-parent', function (event) {
//       event.preventDefault();
...
//     }),
    ...
    // Toggle item on hover, and click
    this.$el.on('hover.navmenu', this.navTrigger + ' > .navmenu-link-parent', function (event) {
      event.preventDefault();
      event.stopPropagation();
      _this.toggleItem(event.currentTarget.parentNode);
    }),
...
//# sourceMappingURL=empire.js.map?1540410927406
